...
private:
    ...
    // 这两个状态是由服务器来维护，易失
    // 这两个状态的下标从1开始，因为通常commitIndex和lastApplied从0开始，应该是一个无效的index，因此下标从1开始
...
public:
    ...
    //有了快照，日志index不能和日志数组中的下标相等了，通过这个index来找到entry在日志数组中的位置
